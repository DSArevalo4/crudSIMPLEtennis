...
class Torneo(Base):
    ...
    def as_dict(self):
        ...
        return {
            'id': self.id,
            'nombre': self.nombre,
            'superficie': self.superficie if hasattr(self, 'superficie') else None,
            'fecha': self.fecha_inicio.isoformat() if self.fecha_inicio else None,
            ...
            'descripcion': self.descripcion if hasattr(self, 'descripcion') else None,
            'fecha_creacion': self.fecha_creacion.isoformat() if hasattr(self, 'fecha_creacion') and self.fecha_creacion else None
        }
